 ...
 *
 */
public interface SkillEventVoiceDispatcher {
	/**
	 * TTS开始事件
	 * 
	 * @param request
	 ...
	 */
	ResResponse voiceStartedEvent(HttpServletRequest request, ReqRequest reqRequest, ReqBasicInfo basicInfo,
	 ...
	 * @throws RokidException
	 */
	ResResponse voiceFailedEvent(HttpServletRequest request, ReqRequest reqRequest, ReqBasicInfo basicInfo,
			HashMap<String, Object> attributes, HashMap<String, Slot> slots, ReqApplicationMedia mediaState,
			ReqApplicationVoice voiceState, ReqExtraMedia mediaExtra, ReqExtraVoice voiceExtra) throws RokidException;
	 ...
	 * @throws RokidException
	 */
	ResResponse voiceFinishedEvent(HttpServletRequest request, ReqRequest reqRequest, ReqBasicInfo basicInfo,
			HashMap<String, Object> attributes, HashMap<String, Slot> slots, ReqApplicationMedia mediaState,
			ReqApplicationVoice voiceState, ReqExtraMedia mediaExtra, ReqExtraVoice voiceExtra) throws RokidException;
}
